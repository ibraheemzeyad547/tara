...
export class HomePage implements OnInit {
  ...
  functionFeachDataFromServer(valColor:any=0){
    this.storesService.dashboard(0,1).then(data=>{
  ...
  functionDataSetTime(){
    setTimeout(()=>{
      this.functionFeachDataFromServer(this.valColor)
    },1000);
  }
  async ngOnInit() {
    this.functionFeachDataFromServer(0);
