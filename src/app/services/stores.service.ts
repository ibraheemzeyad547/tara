...
export class StoresService {
  private baseUrl = "https://hollywoodjo.com/api2";
  public result:any;
  ...
  async addOrdersCart(userId:any,storeId:any,price:any,discountCode:any,mobile:any,backupMobile:any,map:any,locationName:any,notes:any,time:any){
    return new Promise(resolve => {
      this.http.post(this.baseUrl+'/'+"addOrdersCart"+"/"+userId+"/"+storeId+"/"+price+"/"+discountCode+"/"+mobile+"/"+backupMobile+"/"+map+"/"+locationName+"/"+notes+"/"+time,"").subscribe(data => {
  ...
  async productDash(){
    return new Promise(resolve => {
      this.http.get(this.baseUrl+'/'+"productDash/").subscribe(data => {
        return this.result = resolve(data);
      }, err => {
        console.log(err);
      });
  ...
  async dashboardStores(proId:any=0){
    return new Promise(resolve => {
      this.http.get(this.baseUrl+'/'+"dashboardStores/"+proId).subscribe(data => {
        return this.result = resolve(data);
      }, err => {
        console.log(err);
      });
  ...
  async dashboard(proId:any=0,type:any=0){
    return new Promise(resolve => {
      this.http.get(this.baseUrl+'/'+"dashboard/"+proId+"/"+type).subscribe(data => {
        return this.result = resolve(data);
      }, err => {
        console.log(err);
      });
  ...
  async productsSubCat(subCatSelect:any){
    return new Promise(resolve => {
      this.http.get(this.baseUrl+'/'+"productsSubCat/"+subCatSelect).subscribe(data => {
        return this.result = resolve(data);
      }, err => {
        console.log(err);
      });
  ...
  async productsCategories(){
    return new Promise(resolve => {
      this.http.get(this.baseUrl+'/'+"productsCategories").subscribe(data => {
        return this.result = resolve(data);
      }, err => {
        console.log(err);
      });
  ...
  async allProducts(catId:any=0,subCat:any=0,searchData:any=0,regionsId:any=0){
    return new Promise(resolve => {
      if(catId == 0 || catId == "" || catId == undefined)
        catId = 0;
      if(subCat == 0 || subCat == "" || subCat == undefined)
        subCat = 0;
      if(searchData == 0 || searchData == "" || searchData == undefined)
        searchData = 0;
      this.http.get(this.baseUrl+'/'+"allProducts/"+catId+"/"+searchData+"/"+subCat+"/"+regionsId).subscribe(data => {
        return this.result = resolve(data);
      }, err => {
        console.log(err);
      });
  ...
  async checkDiscountCode(discountCode:any,userId:any,allValues:any,storeId:any){
    return new Promise(resolve => {
      this.http.post(this.baseUrl+'/'+"checkDiscountCode"+"/"+discountCode+"/"+userId+"/"+allValues+"/"+storeId,"").subscribe(data => {
        return this.result = resolve(data);
      }, err => {
        console.log(err);
      });
